...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\pandas\tests\io\formats\style\test_tooltip.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pandas.tests.io.formats.style.test_tooltip.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pandas.tests.io.formats.style.test_tooltip.source.html#l7">
