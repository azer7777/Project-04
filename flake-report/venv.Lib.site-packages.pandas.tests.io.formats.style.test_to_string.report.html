...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\pandas\tests\io\formats\style\test_to_string.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pandas.tests.io.formats.style.test_to_string.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pandas.tests.io.formats.style.test_to_string.source.html#l8">
                  <tt><i>8</i> <span class="kn">from</span> <span class="nn">pandas.io.formats.style</span> <span class="kn">import</span> <span class="n">Styler</span></tt>
               </a>
            </li>
            </ul>
         </li>
