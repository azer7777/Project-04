...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\pandas\tests\io\formats\style\test_highlight.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pandas.tests.io.formats.style.test_highlight.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pandas.tests.io.formats.style.test_highlight.source.html#l12">
