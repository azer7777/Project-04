...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\pandas\tests\arrays\masked\test_arrow_compat.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pandas.tests.arrays.masked.test_arrow_compat.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pandas.tests.arrays.masked.test_arrow_compat.source.html#l9">
                  <tt><i>9</i> <span class="kn">from</span> <span class="nn">pandas.core.arrays.arrow._arrow_utils</span> <span class="kn">import</span> <span class="n">pyarrow_array_to_numpy_and_mask</span></tt>
               </a>
            </li>
            </ul>
         </li>
